...
void setup() {
//Serial.begin(9600);
pinMode(3,OUTPUT);pinMode(10,OUTPUT);pinMode(11,OUTPUT);
pinMode(inputPin, INPUT_PULLUP);
pinMode(inputPin1, INPUT_PULLUP);
pinMode(inputPin2, INPUT_PULLUP);
attachInterrupt(digitalPinToInterrupt(inputPin), freqCounterCallback, FALLING);
attachInterrupt(digitalPinToInterrupt(inputPin1), freqCounterCallback1, FALLING);
attachInterrupt(digitalPinToInterrupt(inputPin2), freqCounterCallback2, FALLING);
}
void freqCounterCallback()
{
  //fase1
  delayMicroseconds(value);digitalWrite(3, HIGH);delayMicroseconds(40);digitalWrite(3, LOW);
}
void freqCounterCallback1()
{
  //fase1
  delayMicroseconds(value);digitalWrite(10, HIGH);delayMicroseconds(40);digitalWrite(10, LOW);
}
void freqCounterCallback2()
{
  //fase1
  delayMicroseconds(value);digitalWrite(11, HIGH);delayMicroseconds(40);digitalWrite(11, LOW);
}
