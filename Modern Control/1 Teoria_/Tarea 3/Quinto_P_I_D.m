...
pidD=s;
pN=3;
pD=(s-2)*(1+0.05*s+0.00125*s^2);
Planta=collect(pN/pD,s);
PolNum=collect(pidN*pN)*800%multplico por 800 conservo igualdad
PolDen=collect(pidD*pD+pidN*pN,s)*800%divido por 800 conservo igualdad
