...
format compact
syms s kc S
GInt=(116400)/(s^3+0.4899*s^2+25*s)%planta CON INTEGRADORES NECESARIOS
Glcnum=116400;%numerador planta lazo cerrado CON INTEGRADORES NECESARIOS
Glcden=s^3+0.4899*s^2+25*s+116400;%denominador  planta lazo cerrado CON INTEGRADORES NECESARIOS
...
VerPolos=vpa(polo)
polo=polo(3);%poner el polo que tenga la parte imag positiva hallado en la linea anterior
magPolo=abs(polo)%magnitud polo
tsd=8 %como es una planata termica se demora media hora :V
cd=1%como hicimos que el sistema sea mas rapido que en lazo abierto debe ser subamortiguado pero no muchito 
wnd=4/(cd*tsd)
PD=[1 2*cd*wnd wnd^2]
raices=roots(PD)
